...
matches_data = [
    ...
    [5, "2026-06-13", "15:00", 1, 15, 7, 8, 1, 1, "Completed", 0.78, 1.54],
    [6, "2026-06-13", "18:00", 1, 2, 9, 10, 1, 1, "Completed", 1.62, 1.10],
    [7, "2026-06-13", "21:00", 1, 10, 11, 12, 0, 1, "Completed", 1.25, 0.65],
    [8, "2026-06-13", "23:59", 1, 5, 15, 16, 2, 0, "Completed", 1.48, 0.72],
    [9, "2026-06-14", "15:00", 1, 14, 17, 18, 7, 1, "Completed", 4.82, 0.44],
    [10, "2026-06-14", "18:00", 1, 11, 21, 22, 2, 2, "Completed", 1.95, 1.82],
    [11, "2026-06-14", "21:00", 1, 4, 19, 20, 1, 0, "Completed", 1.10, 0.95],
    [12, "2026-06-14", "23:59", 1, 8, 23, 24, 5, 1, "Completed", 3.12, 0.78],
    [13, "2026-06-15", "15:00", 1, 9, 29, 30, 0, 0, "Completed", 2.15, 0.35],
    [14, "2026-06-15", "18:00", 1, 16, 25, 26, 1, 1, "Completed", 1.58, 1.12],
    [15, "2026-06-15", "21:00", 1, 13, 31, 32, 1, 1, "Completed", 0.85, 1.76],
    [16, "2026-06-15", "23:59", 1, 3, 27, 28, 2, 2, "Completed", 1.88, 1.20],
    [17, "2026-06-16", "15:00", 1, 2, 33, 34, 3, 1, "Completed", 2.44, 1.05],
    [18, "2026-06-16", "18:00", 1, 10, 35, 36, 1, 4, "Completed", 0.68, 2.85],
    [19, "2026-06-16", "21:00", 1, 12, 37, 38, 3, 0, "Completed", 2.65, 0.42],
    [20, "2026-06-16", "23:59", 1, 15, 39, 40, 3, 1, "Completed", 1.98, 0.88],
    [21, "2026-06-17", "15:00", 1, 11, 41, 42, 1, 1, "Completed", 1.78, 1.15],
    [22, "2026-06-17", "18:00", 1, 4, 45, 46, 4, 2, "Completed", 2.92, 1.64],
    [23, "2026-06-17", "21:00", 1, 6, 47, 48, 1, 0, "Completed", 1.30, 0.75],
    [24, "2026-06-17", "23:59", 1, 1, 43, 44, 1, 3, "Completed", 0.95, 2.10],

    # Round 2 Scheduled/Completed matches
    [25, "2026-06-18", "15:00", 1, 7, 1, 3, 1, 0, "Completed", 1.62, 0.58],
    [26, "2026-06-18", "18:00", 1, 3, 4, 2, 1, 1, "Completed", 1.35, 1.15],
    [27, "2026-06-18", "21:00", 1, 5, 5, 7, 6, 0, "Completed", 3.82, 0.22],
    [28, "2026-06-18", "23:59", 1, 16, 8, 6, 4, 1, "Completed", 2.45, 0.88],
    [29, "2026-06-19", "15:00", 1, 14, 9, 11, 3, 0, "Completed", 1.16, 0.90],
    [30, "2026-06-19", "18:00", 1, 10, 12, 10, 0, 1, "Completed", 0.97, 0.54],
    [31, "2026-06-19", "21:00", 1, 16, 13, 15, 2, 0, "Completed", 1.21, 0.32],
    [32, "2026-06-19", "23:59", 1, 15, 16, 14, 0, 1, "Completed", 0.40, 0.30],
    [33, "2026-06-20", "15:00", 1, 9, 17, 19, 2, 1, "Completed", 1.85, 0.72],
    [34, "2026-06-20", "18:00", 1, 11, 20, 18, 0, 0, "Completed", 1.92, 0.08],
    [35, "2026-06-20", "21:00", 1, 4, 21, 23, 5, 1, "Completed", 3.45, 0.88],
    [36, "2026-06-20", "23:59", 1, 12, 24, 22, 0, 4, "Completed", 0.35, 3.12],
    [37, "2026-06-21", "15:00", 1, 16, 25, 27, 0, 0, "Completed", 1.45, 0.62],
    [38, "2026-06-21", "18:00", 1, 5, 28, 26, 1, 3, "Completed", 0.55, 2.15],
    [39, "2026-06-21", "21:00", 1, 13, 29, 31, 4, 0, "Completed", 3.28, 0.25],
    [40, "2026-06-21", "23:59", 1, 8, 32, 30, 2, 2, "Completed", 1.65, 1.10],
    [41, "2026-06-22", "15:00", 1, 2, 33, 35, 3, 0, "Completed", 2.21, 0.45],
    [42, "2026-06-22", "18:00", 1, 10, 36, 34, 3, 2, "Completed", 1.95, 1.48],
    [43, "2026-06-22", "21:00", 1, 3, 37, 39, 2, 0, "Completed", 1.78, 0.55],
    [44, "2026-06-22", "23:59", 1, 15, 40, 38, 1, 2, "Completed", 0.88, 1.92],
    [45, "2026-06-23", "15:00", 1, 11, 41, 43, 5, 0, "Completed", 3.54, 0.42],
    [46, "2026-06-23", "18:00", 1, 7, 44, 42, 1, 0, "Completed", 1.62, 0.58],
    [47, "2026-06-23", "21:00", 1, 4, 45, 47, 0, 0, "Completed", 1.12, 0.89],
    [48, "2026-06-23", "23:59", 1, 9, 48, 46, 0, 1, "Completed", 0.42, 1.48],

    # Round 3 Scheduled matches (simultaneous group final matches)
    [49, "2026-06-24", "18:00", 1, 1, 4, 1, 0, 3, "Completed", 1.10, 1.27],
    [50, "2026-06-24", "18:00", 1, 8, 2, 3, 1, 0, "Completed", 1.26, 1.39],
    [51, "2026-06-24", "22:00", 1, 5, 8, 5, 2, 1, "Completed", 0.71, 1.35],
    [52, "2026-06-24", "22:00", 1, 6, 6, 7, 3, 1, "Completed", 1.48, 0.95],
    [53, "2026-06-25", "18:00", 1, 13, 12, 9, 0, 3, "Completed", 0.45, 2.18],
    [54, "2026-06-25", "18:00", 1, 9, 10, 11, 4, 2, "Completed", 2.35, 1.12],
    [55, "2026-06-25", "22:00", 1, 3, 16, 13, 3, 2, "Completed", 1.62, 1.45],
    [56, "2026-06-25", "22:00", 1, 16, 14, 15, 0, 0, "Completed", 0.55, 0.48],
    [57, "2026-06-26", "18:00", 1, 11, 20, 17, 2, 1, "Completed", 1.28, 1.55],
    [58, "2026-06-26", "18:00", 1, 14, 18, 19, 0, 2, "Completed", 0.32, 1.68],
    [59, "2026-06-26", "22:00", 1, 12, 24, 21, 1, 3, "Completed", 0.62, 2.15],
    [60, "2026-06-26", "22:00", 1, 15, 22, 23, 1, 1, "Completed", 1.12, 0.95],
    [61, "2026-06-27", "18:00", 1, 5, 28, 25, 1, 5, "Completed", 0.48, 3.25],
    [62, "2026-06-27", "18:00", 1, 16, 26, 27, 1, 1, "Completed", 0.85, 0.92],
    [63, "2026-06-27", "22:00", 1, 13, 32, 29, 0, 1, "Completed", 0.78, 1.35],
    [64, "2026-06-27", "22:00", 1, 9, 30, 31, 0, 0, "Completed", 0.42, 0.38],
    [65, "2026-06-26", "18:00", 1, 10, 36, 33, 1, 4, "Completed", 1.30, 0.96],
    [66, "2026-06-26", "18:00", 1, 6, 34, 35, 5, 0, "Completed", 3.01, 0.14],
    [67, "2026-06-27", "22:00", 1, 4, 40, 37, 1, 3, "Completed", 0.76, 2.13],
    [68, "2026-06-27", "22:00", 1, 12, 38, 39, 3, 3, "Completed", 1.62, 1.44],
    [69, "2026-06-28", "18:00", 1, 11, 44, 41, 0, 0, "Completed", 1.62, 0.73],
    [70, "2026-06-28", "18:00", 1, 7, 42, 43, 3, 1, "Completed", 2.35, 0.20],
    [71, "2026-06-28", "22:00", 1, 9, 48, 45, 0, 2, "Completed", 0.69, 1.39],
...
player_of_the_match_mapping = {
    ...
    65: 839,   # Masour Ousmane Dembele (FRA)
    66: 871,   # Iliman Cheikh Baroy Ndiaye (SEN)
    67: 946,   # Lionel Andrés Messi (ARG)
    68: 969,   # Riyad Karim Mahrez (ALG)
    69: 1041,  # Diogo Costa (POR)
    70: 1086,  # Yoane Wissa (COD)
...
authentic_referee_ids = {
    ...
    9: 5, 10: 8, 11: 9, 12: 11, 13: 12, 14: 13, 15: 15, 16: 9,
    ...
    41: 16, 42: 17, 43: 18, 44: 19, 45: 20, 46: 18, 47: 22, 48: 23,
    49: 24, 50: 25, 51: 26, 52: 27, 53: 28, 54: 6, 55: 2, 56: 3,
    ...
    97: 16, 98: 3, 99: 10, 100: 17, 101: 10, 102: 6, 103: 7, 104: 20
}
...
for match in matches_data:
    ...
    if m_id_str in overrides_data:
        ...
        event_id_counter += 1
        # France: Aurélien Tchouaméni (840) in 74'
        events_data.append([event_id_counter, 65, 74, "Yellow Card", 33, 840])
        event_id_counter += 1
    elif match_id == 66:
        # Senegal: Abdoulaye Seck (862) in 18', Pape Gueye (884) in 81'
        events_data.append([event_id_counter, 66, 18, "Yellow Card", 34, 862])
        event_id_counter += 1
        events_data.append([event_id_counter, 66, 81, "Yellow Card", 34, 884])
        event_id_counter += 1
        # Iraq: Amir Al-Ammari (900) in 75', Merchas Doski (907) in 90'
        ...
        events_data.append([event_id_counter, 56, 46, "Yellow Card", 15, 386])
        event_id_counter += 1
        # Paraguay: Andrés Cubas (346) in 77'
        events_data.append([event_id_counter, 56, 77, "Yellow Card", 14, 346])
        event_id_counter += 1
    elif match_id == 64:
        # Saudi Arabia: Salem Al-Dawsari (792) in 4', Saud Abdulhamid (786) in 67', Firas Al-Buraikan (789) in 90'
        events_data.append([event_id_counter, 64, 4, "Yellow Card", 31, 792])
        event_id_counter += 1
        events_data.append([event_id_counter, 64, 67, "Yellow Card", 31, 786])
        event_id_counter += 1
        events_data.append([event_id_counter, 64, 90, "Yellow Card", 31, 789])
        event_id_counter += 1
...
real_match_team_stats_data = [
    ...
    # Match 65: Norway 1-4 France (June 26) — sofascore.com
    [65, 36, 47, 9,  5,  3, 8,  0, 4, "sofascore.com", "2026-06-28"],
    [65, 33, 53, 17, 9,  5, 7,  2, 4, "sofascore.com", "2026-06-28"],
    # Match 66: Senegal 5-0 Iraq (June 26) — sofascore.com
    [66, 34, 69, 28, 12, 12, 10, 1, 1, "sofascore.com", "2026-06-28"],
    [66, 35, 31, 6,  1,  3, 11, 0, 7, "sofascore.com", "2026-06-28"],
    # Match 67: Jordan 1-3 Argentina (June 27) — sofascore.com
    [67, 40, 27, 5,  1,  2, 13, 1, 1, "sofascore.com", "2026-06-28"],
    [67, 37, 73, 12, 4,  6, 7,  0, 0, "sofascore.com", "2026-06-28"],
    # Match 68: Algeria 3-3 Austria (June 27) — sofascore.com
    [68, 38, 50, 12, 5,  0, 3,  1, 0, "sofascore.com", "2026-06-28"],
    [68, 39, 50, 10, 3,  3, 7,  3, 2, "sofascore.com", "2026-06-28"],
    # Match 69: Colombia vs Portugal (June 28) — sofascore.com
    [69, 44, 55, 24, 6, 5, 12, 3, 2, "sofascore.com", "2026-06-29"],
    [69, 41, 45, 13, 2, 2, 6,  2, 6, "sofascore.com", "2026-06-29"],
    # Match 70: Congo DR vs Uzbekistan (June 28) — sofascore.com
    [70, 42, 64, 19, 4, 2, 6,  3, 1, "sofascore.com", "2026-06-29"],
    [70, 43, 36, 3,  1, 4, 16, 1, 1, "sofascore.com", "2026-06-29"],
    # Match 71: Panama vs England (June 28) — sofascore.com
    [71, 48, 33, 13, 2, 3, 16, 4, 4, "sofascore.com", "2026-06-29"],
    [71, 45, 67, 17, 6, 7, 13, 4, 2, "sofascore.com", "2026-06-29"],
    # Match 72: Croatia vs Ghana (June 28) — sofascore.com
    [72, 46, 53, 8,  4, 3, 9,  1, 0, "sofascore.com", "2026-06-29"],
    [72, 47, 47, 6,  1, 2, 13, 2, 2, "sofascore.com", "2026-06-29"],
